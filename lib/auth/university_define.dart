...
class UniversityDefine extends StatefulWidget {
  const UniversityDefine({Key? key}) : super(key: key);

  @override
  State<UniversityDefine> createState() => _UniversityDefineState();
}

class _UniversityDefineState extends State<UniversityDefine> {
